...
public class OrderControllerTest {
    ...
    @Test
    void testGetOrders() {
        when(orderService.getOrders(any(DefaultPaginationRequest.class))).thenReturn(mockPaginationResponse);
        ...
        PaginationResponse<OrderModel> result = orderController.getOrders(paginationRequest);
    ...
    void testGetBiggestOrderByYear() throws Exception {
        ...
        when(orderService.getBiggestOrderByYear(year)).thenReturn(mockBiggestOrder);

        OrderModel result = orderController.getBiggestOrderByYear(year);

        verify(orderService, times(1)).getBiggestOrderByYear(year);
